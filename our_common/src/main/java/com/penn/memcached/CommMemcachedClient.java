 ...
 * 
 */
public class CommMemcachedClient {
	private static Logger logger = Logger.getLogger(CommMemcachedClient.class);
	...
	public CommMemcachedClient() {
	}

	public CommMemcachedClient(MemcachedClient client) {
		mc = client;
	}
