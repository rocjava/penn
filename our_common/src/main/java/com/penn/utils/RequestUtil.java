...
public class RequestUtil {
    ...
    public static void saveRequest() {
        ...
        request.getSession().setAttribute(Common.LAST_PAGE, RequestUtil.hashRequestPage(request));
    ...
    public static String retrieveSavedRequest() {
        ...
        String HashedlastPage = (String) session.getAttribute(Common.LAST_PAGE);
